...
QB.Phone.Functions.SetupMails = function(Mails) {
    ...
    $("#mail-header-mail").html(QB.Phone.Data.PlayerData.charinfo.firstname+"."+QB.Phone.Data.PlayerData.charinfo.lastname+"@eyfind.info");
    $("#mail-header-lastsync").html("Zuletzt synchronisiert "+MessageTime);
